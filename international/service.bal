...
configurable string groupId = "international";
configurable string international_delivery_requests = "international-delivery-requests";
...
service on new kafka:Listener(kafkaEndpoint, consumerConfigs) {
    ...
    private final string[] locations =  ["Angola","South Africa", "Botswana"];
    ...
    remote function onConsumerRecord(kafka:AnydataConsumerRecord[] records) returns error? {
        foreach var item in records {
            ...
            if (validation){
                ...
                io:println("Processing 'international' package delivery request...");
